...
gt_root = '/media/zlh/ccbaea80-0264-47ef-a0ea-6941cc7542f2/Seg_pytorch/VOC2012/VOCtrainval/VOC2012/SegmentationClass/pre_encoded/'
pre_root = '/media/zlh/ccbaea80-0264-47ef-a0ea-6941cc7542f2/Seg_caffe/pspnet/predict/'
val_pth = '/media/zlh/ccbaea80-0264-47ef-a0ea-6941cc7542f2/Seg_pytorch/VOC2012/VOCtrainval/VOC2012/ImageSets/Segmentation/val.txt'
n_class = 21
...
if __name__ == '__main__':
    ...
    '''
    val_list = open(val_pth, 'r').read().splitlines()
